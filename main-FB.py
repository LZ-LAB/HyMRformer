            ...
            if it % param['eval_step'] == 0:
                ...
                with torch.no_grad():
                    ...
                    if it - best_valid_iter >= param['valid_patience'] or it == self.num_iterations:
                        ...
                        # # print(mrr_lst)
                        # with open("FBmrr_10iter_Wi.txt", "w") as f:
                        #     for mrr in mrr_lst:
                        #         f.write(str(mrr) + ",")
                        #     f.close()

                        # with open("FBhit1_10iter_Wi.txt", "w") as f:
                        #     for hit1 in hit1_lst:
                        #         f.write(str(hit1) + ",")
                        #     f.close()
                        # with open("FBhit3_10iter_Wi.txt", "w") as f:
                        #     for hit3 in hit3_lst:
                        #         f.write(str(hit3) + ",")
                        #     f.close()
                        # with open("FBhit10_10iter_Wi.txt", "w") as f:
                        #     for hit10 in hit10_lst:
                        #         f.write(str(hit10) + ",")
                        #     f.close()
                        # with open("FBlosses_10iter_Wi.txt", "w") as f:
