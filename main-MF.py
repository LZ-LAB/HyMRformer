...
class Experiment:
    def __init__(self, num_iterations, batch_size, lr, dr, input_drop, hidden_drop, feature_drop,
                 Weight_Size, num_heads, emb_dim, max_ary):          
    ...
    def train_and_eval(self):
        ...
        model = HyMRformer(len(d.ent2id), len(d.rel2id), self.input_drop, self.hidden_drop, self.feature_drop,
                          self.Weight_Size, self.num_heads,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, default="M-FB15K", nargs="?", help="FB-AUTO/JF17K/WikiPeople/M-FB15K.")
    parser.add_argument("--num_iterations", type=int, default=500, nargs="?", help="Number of iterations.")
    
    parser.add_argument("--batch_size", type=int, default=600 , nargs="?", help="Batch size.")
    parser.add_argument("--lr", type=float, default=0.00014, nargs="?", help="Learning rate.")
    parser.add_argument("--dr", type=float, default=0.995, nargs="?", help="Decay rate.")
    
    parser.add_argument("--input_drop", type=float, default=0.8, nargs="?", help="input_drop.")
    parser.add_argument("--hidden_drop", type=float, default=0.1, nargs="?", help="hidden_drop.")
    parser.add_argument("--feature_drop", type=float, default=0, nargs="?", help="feature_drop.")

    parser.add_argument("--Weight_Size", type=float, default=0.5, nargs="?", help="Weight Size.")
    parser.add_argument("--num_heads", type=int, default=8, nargs="?", help="The head number of Attention.")
    ...
    args.ary_list = [2, 3, 4, 5]
    

    
    ### n-ary dataset，WN18RR，FB-AUTO/JF17K/WikiPeople
    ## JF17K
    ...
    param['Weight_Size'] = args.Weight_Size
    param['num_heads'] = args.num_heads
    ...
    Exp = Experiment(num_iterations=param['num_iterations'], batch_size=param['batch_size'], lr=param['lr'], dr=param['dr'],
                     ...
                     Weight_Size=param['Weight_Size'], num_heads=param['num_heads'],
