            ...
            if it % param['eval_step'] == 0:
                ...
                with torch.no_grad():
                    ...
                    if it - best_valid_iter >= param['valid_patience'] or it == self.num_iterations:
                        ...
                        # # print(mrr_lst)
                        # with open("JFmrr_10iter_Wi.txt", "w") as f:
                        #     for mrr in mrr_lst:
                        #         f.write(str(mrr) + ",")
                        #     f.close()

                        # with open("JFhit1_10iter_Wi.txt", "w") as f:
                        #     for hit1 in hit1_lst:
                        #         f.write(str(hit1) + ",")
                        #     f.close()
                        # with open("JFhit3_10iter_Wi.txt", "w") as f:
                        #     for hit3 in hit3_lst:
                        #         f.write(str(hit3) + ",")
                        #     f.close()
                        # with open("JFhit10_10iter_Wi.txt", "w") as f:
                        #     for hit10 in hit10_lst:
                        #         f.write(str(hit10) + ",")
                        #     f.close()
                        # with open("JFlosses_10iter_Wi.txt", "w") as f:
